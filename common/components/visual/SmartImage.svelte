...
<img class={`${$$restProps.class}`} class:d-none={hidden} src={!hidden ? (resolvedImages[index] || `${index}_404.jpg`) : `${index}_404.jpg`} alt='preview' draggable='false' loading='lazy' on:error={handleError} />
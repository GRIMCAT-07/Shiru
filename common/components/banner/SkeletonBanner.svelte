<div class='pl-20 pb-20 justify-content-end d-flex flex-column h-full w-600 mw-full banner'>
  <div class='h-30 skeloader bg-dark-light w-500 mb-30 rounded'><div class='skeleloader-swipe' /></div>
  ...
  <div class='my-15 d-flex h-10 w-150 skeloader bg-dark-light rounded'><div class='skeleloader-swipe' /></div>
  <div class='mb-20 h-30 w-200 skeloader bg-dark-light rounded'><div class='skeleloader-swipe' /></div>
  <div class='pb-15' />
</div>
